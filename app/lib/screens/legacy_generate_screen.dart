...
/// Plan 9-A composer kept as fallback when FeatureFlags.outlineEnabled = false.
///
/// Also used unconditionally for sequel mode (storylineId != null) since
/// sequels MUST NOT go through outline preview (spec §10.1 mutex).
class LegacyGenerateScreen extends ConsumerStatefulWidget {
  ...
  const LegacyGenerateScreen({super.key, this.storylineId});

  @override
  ConsumerState<LegacyGenerateScreen> createState() => _LegacyGenerateScreenState();
}

class _LegacyGenerateScreenState extends ConsumerState<LegacyGenerateScreen> {
